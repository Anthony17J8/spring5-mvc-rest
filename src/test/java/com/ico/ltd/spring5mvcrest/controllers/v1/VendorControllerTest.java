...
import static com.ico.ltd.spring5mvcrest.controllers.v1.AbstractRestControllerTest.asJsonString;
...
class VendorControllerTest {
    ...
    public void getVendors() throws Exception {
        given(vendorService.getVendors()).willReturn(Arrays.asList(vendorDTO_1, vendorDTO_2));
